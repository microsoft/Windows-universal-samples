...
using namespace InclinometerCPP;
...
void Scenario1_DataEvents::VisibilityChanged(Object^ sender, VisibilityChangedEventArgs^ e)
{
    ...
    if (ScenarioDisableButton->IsEnabled)
    {
        if (e->Visible)
        {
            ...
            readingToken = inclinometer->ReadingChanged::add(ref new TypedEventHandler<Inclinometer^, InclinometerReadingChangedEventArgs^>(this, &Scenario1_DataEvents::ReadingChanged));
        }
        else
        {
...
void Scenario1_DataEvents::ReadingChanged(Inclinometer^ sender, InclinometerReadingChangedEventArgs^ e)
{
