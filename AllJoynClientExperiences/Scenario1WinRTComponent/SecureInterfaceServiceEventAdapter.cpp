...
// Methods
IAsyncOperation<SecureInterfaceCatResult^>^ SecureInterfaceServiceEventAdapter::CatAsync(_In_ AllJoynMessageInfo^ info, _In_ Platform::String^ interfaceMemberInStr1, _In_ Platform::String^ interfaceMemberInStr2)
{
    auto args = ref new SecureInterfaceCatCalledEventArgs(info, interfaceMemberInStr1, interfaceMemberInStr2);
