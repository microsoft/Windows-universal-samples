...
void SecureInterfaceProducer::Start()
{
    ...
    alljoyn_interfacedescription interfaceDescription = alljoyn_busattachment_getinterface(AllJoynHelpers::GetInternalBusAttachment(m_busAttachment), "org.alljoyn.example.Samples.Secure.SecureInterface");
...
PCSTR org::alljoyn::example::Samples::Secure::SecureInterface::c_SecureInterfaceIntrospectionXml = "<interface name=\"org.alljoyn.example.Samples.Secure.SecureInterface\">"
