...
namespace CustomHidDeviceAccess
{
    ...
    public class EventHandlerForDevice
    {
        ...
        private TypedEventHandler<EventHandlerForDevice, OnDeviceConnectedEventArgs> deviceConnectedCallback;
        ...
        public TypedEventHandler<EventHandlerForDevice, OnDeviceConnectedEventArgs> OnDeviceConnected
        {
            get
            {
