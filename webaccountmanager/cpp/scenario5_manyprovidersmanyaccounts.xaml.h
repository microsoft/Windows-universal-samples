...
namespace SDKTemplate
{
    ...
    private:
        ...
        const Platform::String^ MSA_SCOPE_REQUESTED = "service::wl.basic::DELEGATION";
        ...
        const Platform::String^ ACCOUNTS_CONTAINER = "accountssettingscontainer";
        const Platform::String^ PROVIDER_ID_SUBCONTAINER = "providers";
        const Platform::String^ AUTHORITY_SUBCONTAINER = "authorities";
        const Platform::String^ APP_SPECIFIC_PROVIDER_ID = "myproviderid";
        const Platform::String^ APP_SPECIFIC_PROVIDER_NAME = "App specific provider";
