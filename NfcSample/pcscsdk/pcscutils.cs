...
namespace Pcsc
{
    ...
    public class SmartCardReaderUtils
    {
        ...
        public static async Task<DeviceInformation> GetDefaultSmartCardReaderInfo()
        {
            ...
            DeviceInformationCollection devices = await DeviceInformation.FindAllAsync("System.Devices.InterfaceClassGuid:=\"{DEEBE6AD-9E01-47E2-A3B2-A66AA2C036C9}\" AND System.Devices.SmartCards.ReaderKind:=" + (int)SmartCardReaderKind.Nfc);
