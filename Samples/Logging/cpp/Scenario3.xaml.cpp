...
Scenario3::Scenario3()
{
    ...
    LoggingScenario->StatusChanged += ref new StatusChangedHandler(this, &Scenario3::OnStatusChanged);
    InitializeComponent();
}

void Scenario3::OnNavigatedTo(Windows::UI::Xaml::Navigation::NavigationEventArgs^ e)
{
    UpdateControls();
}

// This function finds a TextBlock's ScrollViewer.
Windows::UI::Xaml::Controls::ScrollViewer^ Scenario3::FindScrollViewer(DependencyObject^ depObject)
{
...
void Scenario3::AddMessage(Platform::String^ message)
{
...
task<void> Scenario3::AddMessageDispatch(Platform::String^ message)
{
...
task<void> Scenario3::AddLogFileMessageDispatch(Platform::String^ message, const std::wstring& logFileFullPath)
{
    return create_task(Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::High, ref new Windows::UI::Core::DispatchedHandler([=]() {
...
void Scenario3::OnStatusChanged(Platform::Object^ sender, LoggingScenarioEventArgs^ e)
{
...
void Scenario3::EnableDisableLogging(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    if (LoggingScenario->LoggingEnabled)
    {
...
void Scenario3::DoScenario(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    DoScenarioButton->IsEnabled = false;
