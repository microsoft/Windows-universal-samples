...
- path: LICENSE
  target: LICENSE
description: "Shows how to use the Logging APIs in the Windows.Foundation.Diagnostics namespace."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/logging/),
