...
- windows
- windows-uwp
urlFragment: BackButton
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "Shows how to respond to the Back Button event and enable the title bar back button."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/backbutton/),
