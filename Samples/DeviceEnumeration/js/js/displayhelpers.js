...
(function () {
    ...
    var selectorsArray = [
        ...
        { displayName: "Video Casting Devices", selector: Windows.Media.Casting.CastingDevice.getDeviceSelector(Windows.Media.Casting.CastingPlaybackTypes.video) },
        ...
        { displayName: "DIAL Devices (All apps)", selector: Windows.Media.DialProtocol.DialDevice.getDeviceSelector("") },
