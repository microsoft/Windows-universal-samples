...
- windows
- windows-uwp
urlFragment: BasicFaceDetection
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "Shows how to use the FaceDetector to find human faces within a still image."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/basicfacedetection/),
