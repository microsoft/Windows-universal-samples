...
HRESULT __stdcall FilmicEffect::CreateFilmicImpl(_Outptr_ IUnknown** ppEffectImpl)
{
    ...
    *ppEffectImpl = static_cast<ID2D1EffectImpl*>(new (std::nothrow) FilmicEffect());
...
HRESULT FilmicEffect::Register(_In_ ID2D1Factory1* pFactory)
{
    ...
    PCWSTR pszXml =
        XML(
            ...
            <Effect>
                <!-- System Properties -->
                <Property name='DisplayName' type='string' value='Filmic Tonemapper' />
                <Property name='Author' type='string' value='Microsoft Corporation' />
                <Property name='Category' type='string' value='Stylize' />
                <Property name='Description' type='string' value='Simplified version of the ACES Filmic HDR tonemapper' />
                <Inputs>
                    <Input name='Source' />
                </Inputs>
