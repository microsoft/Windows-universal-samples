...
{
    /// <summary>
    /// Multi-video playback control.
    /// </summary>
    public sealed partial class Scenario1_MultiVideoPlayback : Page
    {
        ...
        private Uri[] mediaUris = new Uri[5]
        {
                new Uri("https://mediaplatstorage1.blob.core.windows.net/windows-universal-samples-media/multiangle-right.mp4"),
                new Uri("https://mediaplatstorage1.blob.core.windows.net/windows-universal-samples-media/multiangle-back-high.mp4"),
                new Uri("https://mediaplatstorage1.blob.core.windows.net/windows-universal-samples-media/multiangle-back-low.mp4"),
                new Uri("https://mediaplatstorage1.blob.core.windows.net/windows-universal-samples-media/multiangle-right-back.mp4"),
                new Uri("https://mediaplatstorage1.blob.core.windows.net/windows-universal-samples-media/multiangle-right-shoulder.mp4"),
        };

        public Scenario1_MultiVideoPlayback()
        {
            this.InitializeComponent();
            mediaPlayerElements = new List<MediaPlayerElement>() { mpeMain, mpeTL, mpeTR, mpeBL, mpeBR };
        ...
        {
            Seek10SecondsBack.IsEnabled = enabled;
            PlayPause.IsEnabled = enabled;
            Seek10SecondsForward.IsEnabled = enabled;
        }
        ...
        private void Seek10SecondsForward_Click(object sender, RoutedEventArgs e)
        {
            // Go forward 10 seconds, but not beyond our maximum value.
            var requestedPosition = timelineController.Position + TimeSpan.FromSeconds(10);
        ...
        private void Seek10SecondsBack_Click(object sender, RoutedEventArgs e)
        {
            timelineController.Position -= TimeSpan.FromSeconds(10);
        }
