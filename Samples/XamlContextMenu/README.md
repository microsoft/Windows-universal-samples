...
- windows
- windows-uwp
urlFragment: XamlContextMenu
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "Shows how to create context menu experiences in UWP apps."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/xamlcontextmenu/),
