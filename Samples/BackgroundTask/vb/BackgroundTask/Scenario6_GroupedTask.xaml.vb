...
Namespace Global.SDKTemplate
    ...
    Partial Public NotInheritable Class GroupedBackgroundTask
        ...
        Private Sub RegisterGroupedBackgroundTask(sender As Object, e As RoutedEventArgs)
            Dim task = BackgroundTaskSample.RegisterBackgroundTask(BackgroundTaskSample.SampleBackgroundTaskEntryPoint, BackgroundTaskSample.GroupedBackgroundTaskName, New SystemTrigger(SystemTriggerType.TimeZoneChange, False), Nothing, group)
