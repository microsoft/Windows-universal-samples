...
- windows
- windows-uwp
urlFragment: CameraFaceDetection
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "An end-to-end sample camera application that incorporates face detection."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/camerafacedetection/),
