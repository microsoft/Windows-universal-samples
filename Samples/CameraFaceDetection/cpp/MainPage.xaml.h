...
namespace FaceDetection
{
    ...
    private:
        ...
        Concurrency::task<void> CreateFaceDetectionEffectAsync();
        Concurrency::task<void> CleanUpFaceDetectionEffectAsync();
        ...
        void HighlightDetectedFaces(Windows::Foundation::Collections::IVectorView<Windows::Media::FaceAnalysis::DetectedFace^>^ faces);
        Windows::UI::Xaml::Shapes::Rectangle^ ConvertPreviewToUiRectangle(Windows::Graphics::Imaging::BitmapBounds faceBoxInPreviewCoordinates);
        Windows::Foundation::Rect GetPreviewStreamRectInControl(Windows::Media::MediaProperties::VideoEncodingProperties^ previewResolution, Windows::UI::Xaml::Controls::CaptureElement^ previewControl);
        ...
        void FaceDetectionEffect_FaceDetected(Windows::Media::Core::FaceDetectionEffect^ sender, Windows::Media::Core::FaceDetectedEventArgs^ args);
