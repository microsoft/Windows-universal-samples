...
{
  class HolographicViewSwitcherMain : public DX::IDeviceNotify
  {
  public:
    HolographicViewSwitcherMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
    ~HolographicViewSwitcherMain();
