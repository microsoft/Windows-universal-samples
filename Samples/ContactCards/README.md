...
- windows
- windows-uwp
urlFragment: ContactCards
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "Shows how to display contact cards."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/contactcards/),
