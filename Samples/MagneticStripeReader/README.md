...
- windows
- windows-uwp
urlFragment: MagneticStripeReader
extendedZipContent:
- path: SharedContent
  target: SharedContent
- path: LICENSE
  target: LICENSE
description: "Uses a magnetic stripe reader to read data from a bank card or a motor vehicle card."
---
...
> [from docs.microsoft.com](https://docs.microsoft.com/samples/microsoft/windows-universal-samples/magneticstripereader/),
