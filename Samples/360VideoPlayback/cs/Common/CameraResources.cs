...
namespace _360VideoPlayback.Common
{
    ...
    class CameraResources : Disposer
    {
        ...
        public RenderTargetView BackBufferRenderTargetView => d3dRenderTargetView;
        public DepthStencilView DepthStencilView => d3dDepthStencilView;
        public Texture2D BackBufferTexture2D => d3dBackBuffer;

        // Render target properties.
        public RawViewportF Viewport => d3dViewport;
        public SharpDX.DXGI.Format BackBufferDxgiFormat => dxgiFormat;
        public Size RenderTargetSize => d3dRenderTargetSize;
        public bool IsRenderingStereoscopic => isStereo;

        // Associated objects.
        public HolographicCamera HolographicCamera => holographicCamera;
    }
}
