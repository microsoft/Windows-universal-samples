...
namespace SDKTemplate
{
    ...
    {
    internal:
        enum class RecCornor { TopLeft, TopRight, BottomLeft, BottomRight };
        enum class ManipulationTypes { None, Move, Size };
    ...
    private:
        ...
        void ResizeSelectedInkStrokes(float scale, Windows::Foundation::Numerics::float2& center);
