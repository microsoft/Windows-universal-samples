...
namespace CameraVideoStabilization
{
    ...
    private:
        ...
        Windows::Foundation::EventRegistrationToken _videoStabilizationEnabledToken;
        ...
        Concurrency::task<void> CreateVideoStabilizationEffectAsync();
        Concurrency::task<void> SetUpVideoStabilizationRecommendationAsync();
        Concurrency::task<void> CleanUpVideoStabilizationEffectAsync();
