...
namespace Notifications.ScenarioPages.Toasts.ToastNotificationManagerHistory.Remove.ByTagAndGroup
{
    ...
    public sealed partial class ScenarioElement : UserControl
    {
        ...
        private void Initialize()
        {
            ...
            // Pop the toasts
            ToastHelper.PopToast("Group 1, Toast 1", "This is the first toast in group one", TAG_1, GROUP_1);
            ToastHelper.PopToast("Group 1, Toast 2 - TO BE REMOVED", "This is the second toast in group one, should be removed when you click the button", TAG_2, GROUP_1);
            ToastHelper.PopToast("Group 1, Toast 3", "This is the third toast in group one", TAG_3, GROUP_1);
        ...
        {
            ToastNotificationManager.History.Remove(TAG_2, GROUP_1);
        }
    }
}
