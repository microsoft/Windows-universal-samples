...
namespace CameraHdr
{
    ...
    private:
        ...
        Concurrency::task<void> EnableHdrAsync();
        Concurrency::task<void> DisableHdrAsync();
        Concurrency::task<void> TakePhotoInCurrentModeAsync();
        Concurrency::task<void> TakeNormalPhotoAsync();
        Concurrency::task<void> TakeHdrPhotoAsync();
