...
#include "Scenario_PredefinedDictationGrammar.g.h"
...
namespace SDKTemplate
{
    ...
    public ref class Scenario_PredefinedDictationGrammar sealed
    {
    public:
    ...
    private:
        ...
        void RecognizeWithUIDictationGrammar_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
        void RecognizeWithoutUIDictationGrammar_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
