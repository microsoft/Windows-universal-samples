...
(function () {
    ...
    function initializeRecognizer(language) {
        ...
        recognizer.constraints.append(webSearchConstraint);

        // RecognizeWithUIAsync allows developers to customize the prompts.    
        recognizer.uiOptions.audiblePrompt = "Say what you want to search for...";
        recognizer.uiOptions.exampleText = resourceMap.getValue('DictationUIOptionsExampleText', context).valueAsString;
