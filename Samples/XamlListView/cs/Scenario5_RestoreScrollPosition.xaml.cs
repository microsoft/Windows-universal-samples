...
{
    public sealed partial class Scenario5_RestoreScrollPosition : Page
    {
        ...
        private ObservableCollection<Item> _items = Item.GetItems(300);
        ...
        public Scenario5_RestoreScrollPosition()
        {
            InitializeComponent();
        }
        ...
        private async void Page_Loaded(object sender, RoutedEventArgs e)
        {
            if (!string.IsNullOrEmpty(_persistedPosition))
            {
                ...
                await ListViewPersistenceHelper.SetRelativeScrollPositionAsync(this.ItemsListView, _persistedPosition, this.GetItem);
            }
        }
        ...
        protected override void OnNavigatingFrom(NavigatingCancelEventArgs e)
        {
            ...
            _persistedPosition = ListViewPersistenceHelper.GetRelativeScrollPosition(this.ItemsListView, this.GetKey);
        }
