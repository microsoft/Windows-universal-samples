...
{
    struct Scenario03_GetList : Scenario03_GetListT<Scenario03_GetList>
    {
        Scenario03_GetList();
...
{
    struct Scenario03_GetList : Scenario03_GetListT<Scenario03_GetList, implementation::Scenario03_GetList>
    {
    };
}
