...
Scenario1::Scenario1() : rootPage(SDKTemplate::MainPage::Current)
{
    InitializeComponent();
...
void Scenario1::target_PointerPressed(Platform::Object^ sender, PointerRoutedEventArgs^ e)
{
...
void Scenario1::target_PointerReleased(Platform::Object^ sender, PointerRoutedEventArgs^ e)
{
...
void Scenario1::target_PointerEntered(Platform::Object^ sender, PointerRoutedEventArgs^ e)
{
...
void Scenario1::target_PointerExited(Platform::Object^ sender, PointerRoutedEventArgs^ e)
{
...
// the object
void Scenario1::target_Tapped(Platform::Object^ sender, TappedRoutedEventArgs^ e)
{
...
void Scenario1::target_DoubleTapped(Platform::Object^ sender, DoubleTappedRoutedEventArgs^ e)
{
...
// on an object.
void Scenario1::target_RightTapped(Platform::Object^ sender, RightTappedRoutedEventArgs^ e)
{
...
void Scenario1::target_Holding(Platform::Object^ sender, HoldingRoutedEventArgs^ e)
{
