...
{
    public sealed partial class Scenario_Document1 : Page
    {
        public Scenario_Document1()
        {
        ...
        private void Page_Loaded(object sender, Windows.UI.Xaml.RoutedEventArgs e)
        {
            ...
            this.FontFamily = new Windows.UI.Xaml.Media.FontFamily("Neue Haas Grotesk Text Pro");
        }
    }
}
