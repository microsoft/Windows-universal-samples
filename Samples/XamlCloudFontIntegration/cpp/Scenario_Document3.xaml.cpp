...
void Scenario_Document3::Page_Loaded(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    this->FontFamily = ref new Windows::UI::Xaml::Media::FontFamily("Kokila");
}
