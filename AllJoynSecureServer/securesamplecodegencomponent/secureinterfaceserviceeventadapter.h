...
public:
    ...
    virtual Windows::Foundation::IAsyncOperation<SecureInterfaceCatResult^>^ CatAsync(_In_ Windows::Devices::AllJoyn::AllJoynMessageInfo^ info, _In_ Platform::String^ interface_inStr1, _In_ Platform::String^ interface_inStr2);
