...
- Initialize and execute FaceTracker on the live webcam stream
- Retrieve FaceTracker results and visualize them
...
The FaceTracker is intended to be used against a running video stream. In order to detect human faces within a static image (photograph) or a single video frame, use the FaceDetector API instead.
