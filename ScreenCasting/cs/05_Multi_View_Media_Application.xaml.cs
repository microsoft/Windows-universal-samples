    ...
    public sealed partial class Scenario05 : Page
    {
        ...
        private async void Picker_DeviceSelected(DevicePicker sender, DeviceSelectedEventArgs args)
        {
            ...
            await Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, async () =>
            {
                ...
                DeviceInformation selectedDevice = await DeviceInformation.CreateFromIdAsync(args.SelectedDevice.Id);
                ...
                try
                {
                    ...
                    if (ProjectionManager.ProjectionDisplayAvailable && pvb.ProjectedPage != null)
                    {
                        ...
                        try { picker.SetDisplayStatus(args.SelectedDevice, "Connected", DevicePickerDisplayStatusOptions.ShowDisconnectButton); } catch { }
