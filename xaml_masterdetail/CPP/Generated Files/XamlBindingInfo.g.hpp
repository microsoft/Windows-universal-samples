...
namespace XamlBindingInfo
{
    ...
    {
    internal:
        static void Set_Windows_UI_Xaml_Controls_TextBlock_Text(::Windows::UI::Xaml::Controls::TextBlock^ obj, ::Platform::String^ value, int expectedPhase, int currentPhase, ::Platform::String^ targetNullValue)
        {
        ...
        static void Set_Windows_UI_Xaml_Controls_ContentPresenter_Content(::Windows::UI::Xaml::Controls::ContentPresenter^ obj, ::Platform::Object^ value, int expectedPhase, int currentPhase, ::Platform::String^ targetNullValue)
        {
            if (shouldUpdate(expectedPhase, currentPhase))
            {
                if (value == nullptr && targetNullValue != nullptr)
