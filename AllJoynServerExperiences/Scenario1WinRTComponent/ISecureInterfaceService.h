...
public:
    ...
    Windows::Foundation::IAsyncOperation<SecureInterfaceCatResult^>^ CatAsync(Windows::Devices::AllJoyn::AllJoynMessageInfo^ info , _In_ Platform::String^ interfaceMemberInStr1, _In_ Platform::String^ interfaceMemberInStr2);
