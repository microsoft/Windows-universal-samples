...
void SecureInterfaceWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "org.alljoyn.example.Samples.Secure.SecureInterface" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "org.alljoyn.example.Samples.Secure.SecureInterface"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "org.alljoyn.example.Samples.Secure.SecureInterface"),
            port);
        Added(this, args);
    }
