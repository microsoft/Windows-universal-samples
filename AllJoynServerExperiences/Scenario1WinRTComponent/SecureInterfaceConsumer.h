...
public:
    ...
    // Call the Cat method
    Windows::Foundation::IAsyncOperation<SecureInterfaceCatResult^>^ CatAsync(_In_ Platform::String^ interfaceMemberInStr1, _In_ Platform::String^ interfaceMemberInStr2);
