This sample demonstrates use of the Windows.Security.Authentication.Web.Core.WebAuthenticationCoreManager API for getting and saving user accounts/account tokens.
