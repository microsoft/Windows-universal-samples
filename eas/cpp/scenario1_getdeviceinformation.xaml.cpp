...
void EAS::Scenario1_GetDeviceInformation::Launch_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	DeviceID->Text = "";
	FriendlyName->Text = "";
...
void EAS::Scenario1_GetDeviceInformation::Reset_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	try
	{
		DeviceID->Text = "";
