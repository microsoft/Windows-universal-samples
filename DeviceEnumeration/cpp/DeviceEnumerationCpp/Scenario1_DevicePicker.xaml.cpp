...
void Scenario1::HideDevicePickerButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    devicePicker->Hide();
}
    ...
    else
    {
            ...
            [this](DevicePicker^ sender, Object^ obj)
        {
            ...
            rootPage->Dispatcher->RunAsync(CoreDispatcherPriority::Low, ref new DispatchedHandler(
                [this]()
            {
                hideDevicePickerButton->IsEnabled = false;
                showDevicePickerButton->IsEnabled = true;
        ...
        hideDevicePickerButton->IsEnabled = true;
    }
}
