...
namespace SDKTemplate
{
    ...
    {
        public const string FEATURE_NAME = "Device Enumeration C# Sample";
        ...
        List<Scenario> scenarios = new List<Scenario>
        {
            ...
            new Scenario() { Title= "Adv: Custom Filter with Additional Properties", ClassType=typeof(Scenario6)},
            new Scenario() { Title= "Adv: Request Specific DeviceInformationKind", ClassType=typeof(Scenario7)},
            new Scenario() { Title= "Adv: Pair Device", ClassType=typeof(Scenario8)}
        };
    }
